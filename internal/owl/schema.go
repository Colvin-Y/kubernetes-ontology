...
var dataPropertySpecs = []DataPropertySpec{
	...
	{ID: "sourceType", Comment: "Edge provenance source type: explicit_ref, selector_match, owner_reference, binding_resolution, inference_rule, or observed.", Domain: "RelationAssertion", Range: "string"},
